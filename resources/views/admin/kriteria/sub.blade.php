                        ...
                        <form action="{{ route('subkriteria.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mb-3">
                                    <label for="subkriteria_nama" class="form-label">Nama</label>
                                    <input type="text" id="subkriteria_nama" name="subkriteria_nama" class="form-control"
                                        placeholder="..." required>
                                </div>
                                <div class="form-group mb-3">
                                    <label for="subkriteria_berat" class="form-label">Kode
                                        Kriteria</label>
                                    <input type="text" id="subkriteria_berat" name="subkriteria_berat"
